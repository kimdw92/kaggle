# 모델을 학습시키고 저장하는 기능
# 1. argaparse로 키워드 인자를 입력 받는다
# 2. 전처리된 데이터를 읽어서 학습셋과 검증셋으로 나눈다
# 3. CateDataset 인스턴스를 사용해서 학습에 적합한 형태의 샘플을 가져온다
# 4. 허깅페이스 transformers가 제공하는 AdamW와 스케쥴러로 학습 준비
# 5. train() 함수로 학습
...
import random
import argparse
import my_cate_dataset
import my_cate_model
import numpy as np
import pandas as pd
